...
dcgauld.quotes = (function() {
  ...
  loaded = function() {
    ...
    heading.innerHTML = "\"" + quotes[getDayOfTheYear() - 1] + "\"";
  ...
  getDayOfTheYear = function() {
    var date = new Date(),
      ...
      month = date.getMonth(),
      day = date.getDate(),
      start = new Date(year, 0, 1, 12, 0, 0), // noon on January 1st
      today = new Date(year, month, day, 12, 0, 0); // noon today
...
if (addEventListener) {
  window.addEventListener("load", dcgauld.quotes.loaded, false);
}